...
@JsonKey(name: "id") int get id;@JsonKey(name: "CategoryId") int get categoryId;@JsonKey(name: "categoryName") String get categoryName;@JsonKey(name: "sku") String get sku;@JsonKey(name: "name") String get name;@JsonKey(name: "description") String get description;@JsonKey(name: "weight") int get weight;@JsonKey(name: "width") int get width;@JsonKey(name: "length") int get length;@JsonKey(name: "height") int get height;@JsonKey(name: "image") String get image;@JsonKey(name: "harga") int get harga;
...
@override
String toString() {
  return 'ProductReq(id: $id, categoryId: $categoryId, categoryName: $categoryName, sku: $sku, name: $name, description: $description, weight: $weight, width: $width, length: $length, height: $height, image: $image, harga: $harga)';
}
...
@useResult
$Res call({
@JsonKey(name: "id") int id,@JsonKey(name: "CategoryId") int categoryId,@JsonKey(name: "categoryName") String categoryName,@JsonKey(name: "sku") String sku,@JsonKey(name: "name") String name,@JsonKey(name: "description") String description,@JsonKey(name: "weight") int weight,@JsonKey(name: "width") int width,@JsonKey(name: "length") int length,@JsonKey(name: "height") int height,@JsonKey(name: "image") String image,@JsonKey(name: "harga") int harga
});
...
class _ProductReq implements ProductReq {
  const _ProductReq({@JsonKey(name: "id") required this.id, @JsonKey(name: "CategoryId") required this.categoryId, @JsonKey(name: "categoryName") required this.categoryName, @JsonKey(name: "sku") required this.sku, @JsonKey(name: "name") required this.name, @JsonKey(name: "description") required this.description, @JsonKey(name: "weight") required this.weight, @JsonKey(name: "width") required this.width, @JsonKey(name: "length") required this.length, @JsonKey(name: "height") required this.height, @JsonKey(name: "image") required this.image, @JsonKey(name: "harga") required this.harga});
